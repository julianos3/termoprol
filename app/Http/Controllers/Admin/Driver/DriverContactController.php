...
class DriverContactController extends Controller
{
    ...
    public function __construct(DriverContactRepository $repository,
                                DriverContactValidator $validator)
    {
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.driver-contact.index', compact('dados', 'config'));
    }

    public function header()
    {
        $config['title'] = "Motoristas > Cadastrados";
    ...
    public function show($id)
    {
        ...
        return view('admin.driver-contact.show', compact('dados', 'config'));
    }
    ...
    public function export(Request $request)
    {
        ...
        header("Content-Disposition: attachment; filename=\"Motoristas_Cadastrados_" . date('Ymds') . ".csv\"");
