...
use AgenciaS3\Repositories\BannerPageRepository;
use AgenciaS3\Services\UtilObjeto;
use AgenciaS3\Validators\BannerMobileValidator;
use AgenciaS3\Validators\BannerPageValidator;
...
class BannerPageController extends Controller
{
    ...
    public function __construct(BannerPageRepository $repository,
                                BannerPageValidator $validator,
                                UtilObjeto $utilObjeto)
    {
        $this->repository = $repository;
        $this->validator = $validator;
        $this->utilObjeto = $utilObjeto;
        $this->path = 'uploads/banner-page/';
    }
    ...
    public function index()
    {
        ...
        return view('admin.banner.page.index', compact('dados', 'config'));
    }

    public function header()
    {
        $config['title'] = "Banner > Páginas";
    ...
    public function create()
    {
        ...
        return view('admin.banner.page.create', compact('config'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.banner.page.edit', compact('dados', 'config'));
    }
