...
class BannerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.banner.desktop.index', compact('dados', 'config'));
    }

    public function header()
    {
        $config['title'] = "Banner > Desktop";
        $config['activeMenu'] = "banner";
        $config['activeMenuN2'] = "desktop";
    ...
    public function create()
    {
        ...
        return view('admin.banner.desktop.create', compact('config'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.banner.desktop.edit', compact('dados', 'config'));
    }
