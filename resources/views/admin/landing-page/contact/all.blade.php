    ...
    <section role="main" class="content-body">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                @include('admin.landing-page.contact._form_filter', ['routeContact' => 'all'])
                    ...
                    @foreach($dados as $row)
                        <tr>
                            ...
                            <td class="actions text-center" data-title="Ação">
                                <a href="{{ route('admin.landing-page.contact.show', ['id' => $row->id]) }}?all=true" class="btn btn-default white-hover" title="Visualizar"><i class="fa el-icon-search"></i></a>
