...
$style = [
    ...
    'body' => 'margin: 0; padding: 0; width: 100%; background-color: #094278;',
    'email-wrapper' => 'width: 100%; margin: 0; padding: 0; background-color: #094278;',
                            ...
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                    ...
                                    <p style="{{ $style['paragraph'] }}">
                                        Landing Page: {{ $data->landingPage->name }}<br />
                                        Nome: {{ $data->name }}<br />
